...
Persistent<FunctionTemplate> TiImagesizeModule::proxyTemplate = Persistent<FunctionTemplate>();
...
void TiImagesizeModule::bindProxy(Handle<Object> exports)
{
	...
	Handle<String> nameSymbol = String::NewSymbol("TiImagesize");
...
void TiImagesizeModule::dispose()
{
	LOGD(TAG, "dispose()");
	if (!proxyTemplate.IsEmpty()) {
...
Handle<FunctionTemplate> TiImagesizeModule::getProxyTemplate()
{
	if (!proxyTemplate.IsEmpty()) {
...
, javaClass, nameSymbol);
	...
	proxyTemplate->Set(titanium::Proxy::inheritSymbol,
		FunctionTemplate::New(titanium::Proxy::inherit<TiImagesizeModule>)->GetFunction());

	titanium::ProxyFactory::registerProxyPair(javaClass, *proxyTemplate);

	// Method bindings --------------------------------------------------------
	DEFINE_PROTOTYPE_METHOD(proxyTemplate, "getSize", TiImagesizeModule::getSize);
...
// Methods --------------------------------------------------------------------
Handle<Value> TiImagesizeModule::getSize(const Arguments& args)
{
	LOGD(TAG, "getSize()");
	HandleScope scope;
